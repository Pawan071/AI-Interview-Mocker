        ...
        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p class="mt-1 text-sm text-gray-600">
              Just need fill the form Job Position ,Tech Stack , Year of
              Experience to personalize your to Start AI Interview Mock.
            </p>
          </a>
          <a
            class="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-blue-500/10 hover:shadow-blue-500/10"
          ...
          >
            ...
            <p class="mt-1 text-sm text-gray-600">
              User Futhur can edit there form once the Interview completed In
              dashbord user can see the previews Interview result.
            </p>
          </a>
          <a
            class="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-blue-500/10 hover:shadow-blue-500/10"
          ...
          >
            ...
            <h2 class="mt-4 text-xl font-bold text-black">
              Accepting Responses Feedback
            </h2>
            <p class="mt-1 text-sm text-gray-600">
              Once the Interview Completed the AI-Interview-Mocker give Feedback
              to the user
            </p>
          </a>
        </div>
